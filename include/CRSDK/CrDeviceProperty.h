...
enum CrDevicePropertyCode : CrInt32u
{
	...
	CrDeviceProperty_StillImageQuality,
	CrDeviceProperty_JpegQuality = CrDeviceProperty_StillImageQuality, /* Do not use. Will be removed in the next release. */
	...
	CrDeviceProperty_MediaSLOT1_JpegQuality = CrDeviceProperty_MediaSLOT1_ImageQuality, /* Do not use. Will be removed in the next release. */
	CrDeviceProperty_MediaSLOT2_ImageQuality,
	CrDeviceProperty_MediaSLOT2_JpegQuality = CrDeviceProperty_MediaSLOT2_ImageQuality, /* Do not use. Will be removed in the next release. */
	...
	CrDeviceProperty_FaceEyeDetectionAF = CrDeviceProperty_SubjectRecognitionAF, /* Do not use. Will be removed in the next release. */
	...
	CrDeviceProperty_NDPresetOrVariableSwitchingSetting = CrDeviceProperty_NDFilterSwitchingSetting, /* Do not use. Will be removed in the next release. */
	...
	CrDeviceProperty_PanTiltAccelerationRampCurve,
	CrDeviceProperty_PanLimitMode,
	CrDeviceProperty_PanLimitRangeMinimum,
	CrDeviceProperty_PanLimitRangeMaximum,
	CrDeviceProperty_TiltLimitMode,
	CrDeviceProperty_TiltLimitRangeMinimum,
	CrDeviceProperty_TiltLimitRangeMaximum,
	CrDeviceProperty_PresetPTZFSlotNumber,
	CrDeviceProperty_IRRemoteSetting,
	CrDeviceProperty_IPSetupProtocolSetting,
	CrDeviceProperty_IrisCloseSetting,
	CrDeviceProperty_LanguageSetting,
	CrDeviceProperty_PaintLookUserMatrixSetting,
	CrDeviceProperty_PaintLookUserMatrixLevel,
	CrDeviceProperty_PaintLookUserMatrixPhase,
	CrDeviceProperty_PaintLookUserMatrixRG,
	CrDeviceProperty_PaintLookUserMatrixRB,
	CrDeviceProperty_PaintLookUserMatrixGR,
	CrDeviceProperty_PaintLookUserMatrixGB,
	CrDeviceProperty_PaintLookUserMatrixBR,
	CrDeviceProperty_PaintLookUserMatrixBG,
	CrDeviceProperty_PaintLookMultiMatrixSetting,
	CrDeviceProperty_PaintLookMultiMatrixAxis,
	CrDeviceProperty_PaintLookMultiMatrixHue,
	CrDeviceProperty_PaintLookMultiMatrixSaturation,
	CrDeviceProperty_PaintLookMultiMatrixAreaIndication,
	CrDeviceProperty_AudioInputCH1LevelControl,
	CrDeviceProperty_AudioInputCH2LevelControl,
	CrDeviceProperty_AudioInputCH3LevelControl,
	CrDeviceProperty_AudioInputCH4LevelControl,
	CrDeviceProperty_AudioInputCH1Level,
	CrDeviceProperty_AudioInputCH2Level,
	CrDeviceProperty_AudioInputCH3Level,
	CrDeviceProperty_AudioInputCH4Level,
	CrDeviceProperty_AudioInputCH1InputSelect,
	CrDeviceProperty_AudioInputCH2InputSelect,
	CrDeviceProperty_AudioInputCH3InputSelect,
	CrDeviceProperty_AudioInputCH4InputSelect,
	CrDeviceProperty_AudioInputCH1WindFilter,
	CrDeviceProperty_AudioInputCH2WindFilter,
	CrDeviceProperty_AudioInputCH3WindFilter,
	CrDeviceProperty_AudioInputCH4WindFilter,
	CrDeviceProperty_AudioInput1TypeSelect,
	CrDeviceProperty_AudioInput2TypeSelect,
	CrDeviceProperty_RemoteKeyThumbnailButton,
	CrDeviceProperty_RemoteKeySLOTSelectButton,
	CrDeviceProperty_VideoRecordingFormatBitrateSetting,
	CrDeviceProperty_VideoRecordingFormatQuality,
	CrDeviceProperty_MonitoringOutputFormat,
	CrDeviceProperty_MonitoringOutputDisplaySetting1,
	CrDeviceProperty_MonitoringOutputDisplaySetting2,
	CrDeviceProperty_FocusSpeedDirectSync,
	CrDeviceProperty_LiveViewImageQualityByNumericalValue,
	CrDeviceProperty_TallyLampControlRed,
	CrDeviceProperty_TallyLampControlGreen,
	CrDeviceProperty_TallyLampControlYellow,
	CrDeviceProperty_ZoomOperationWithInt16,
	CrDeviceProperty_FocusOperationWithInt16,
	CrDeviceProperty_Movie_RecordingResolutionForRTSP,
	CrDeviceProperty_Movie_RecordingResolutionForRAW,
	CrDeviceProperty_Movie_RecordingFrameRateRTSPSetting,
	CrDeviceProperty_PictureCacheRecSetting,
	CrDeviceProperty_PictureCacheRecSizeAndTime,
	CrDeviceProperty_Movie_IntervalRecFrames,
	CrDeviceProperty_ImagerScanMode,
	CrDeviceProperty_ShootingEnableSettingLicense,
	CrDeviceProperty_GridLineDisplayPlayback,
	CrDeviceProperty_GridLineType,
	CrDeviceProperty_DifferentSetForSQMovie,
	CrDeviceProperty_ManualInputForNDFilterValue,
	CrDeviceProperty_LogShootingMode,
	CrDeviceProperty_LogShootingModeColorGamut,
	CrDeviceProperty_TargetStreamingDestinationSelect,
	CrDeviceProperty_StreamDisplayName,
	CrDeviceProperty_VideoStreamSelect,
	CrDeviceProperty_VideoStreamResolution,
	CrDeviceProperty_VideoStreamMaxBitRate,
	CrDeviceProperty_VideoStreamAdaptiveRateControl,
	CrDeviceProperty_VideoStreamCodec,
	CrDeviceProperty_StreamLatency,
	CrDeviceProperty_StreamTTL,
	CrDeviceProperty_StreamCipherType,
	CrDeviceProperty_StreamModeSetting,
	CrDeviceProperty_VideoStreamResolutionMethod,
	CrDeviceProperty_VideoStreamMovieRecPermission,
	CrDeviceProperty_VideoStreamBitRateCompressionMode,
	CrDeviceProperty_VideoStreamBitRateVBRMode,
	CrDeviceProperty_AudioStreamCodecType,
	CrDeviceProperty_AudioStreamSamplingFrequency,
	CrDeviceProperty_AudioStreamBitDepth,
	CrDeviceProperty_AudioStreamChannel,
	CrDeviceProperty_HomeMenuSetting,
	CrDeviceProperty_CallSetting,
	CrDeviceProperty_NDFilterPositionSetting,
	CrDeviceProperty_EframingAutoFraming,
	CrDeviceProperty_EframingTrackingStartMode,
	CrDeviceProperty_EframingProductionEffect,
	CrDeviceProperty_EframingSpeedPTZ,
	CrDeviceProperty_DigitalExtenderMagnificationSetting,
	CrDeviceProperty_MovieRecReviewPlayingState,
	...
	CrDeviceProperty_LiveViewProtocol,
	...
	CrDeviceProperty_AreaTimeZoneSettingVersion,
	CrDeviceProperty_SetPresetPTZFBinaryVersion,
	CrDeviceProperty_PanPositionStatus,
	CrDeviceProperty_TiltPositionStatus,
	CrDeviceProperty_PanPositionCurrentValue,
	CrDeviceProperty_TiltPositionCurrentValue,
	CrDeviceProperty_CameraPowerStatus,
	CrDeviceProperty_RecordablePowerSources,
	CrDeviceProperty_DisplayedMenuStatus,
	CrDeviceProperty_PlaybackContentsRecordingDateTime,
	CrDeviceProperty_PlaybackContentsName,
	CrDeviceProperty_PlaybackContentsNumber,
	CrDeviceProperty_PlaybackContentsTotalNumber,
	CrDeviceProperty_PlaybackContentsRecordingResolution,
	CrDeviceProperty_PlaybackContentsRecordingFrameRate,
	CrDeviceProperty_PlaybackContentsRecordingFileFormat,
	CrDeviceProperty_PlaybackContentsGammaType,
	CrDeviceProperty_BaseLookNameofPlayback,
	CrDeviceProperty_BaseLookAppliedofPlayback,
	CrDeviceProperty_MonitoringOutputDisplaySettingDestAssign,
	CrDeviceProperty_FocusModeStatus,
	CrDeviceProperty_FocusOperationWithInt16EnableStatus,
	CrDeviceProperty_ValidRecordingVideoFormat,
	CrDeviceProperty_LensSerialNumber,
	CrDeviceProperty_MaximumSizeOfImageIDString,
	CrDeviceProperty_StreamStatus,
	CrDeviceProperty_StreamButtonEnableStatus,
	CrDeviceProperty_StreamSettingListOperationStatus,
	CrDeviceProperty_VideoStreamSettingVersion,
	CrDeviceProperty_EframingType,
	CrDeviceProperty_EframingCommandVersion,
	CrDeviceProperty_DeleteContentOperationEnableStatusSLOT1,
	CrDeviceProperty_DeleteContentOperationEnableStatusSLOT2,
	CrDeviceProperty_SceneFileCommandVersion,
	CrDeviceProperty_SceneFileUploadOperationEnableStatus,
...
enum CrLiveViewPropertyCode : CrInt32u
{
	...
	CrLiveViewProperty_FramingFrame = CrDevicePropertyCode::CrDeviceProperty_EframingType,
...
enum CrMeteringMode : CrInt16u
{
	...
	CrMetering_Standard,
	CrMetering_Backlight,
	CrMetering_Spotlight,
};
...
enum CrSlotStatus : CrInt16u
{
	...
	CrSlotStatus_DBError,
	CrSlotStatus_CardRecognizing,
	CrSlotStatus_CardLockedAndDBError,
	CrSlotStatus_DBError_CantRepairAndNeedFormat,
	CrSlotStatus_CardError_ReadOnlyMedia
};
...
enum CrFramingFrameType : CrInt16u
{
...
enum CrFrameInfoType : CrInt16u
{
	...
	CrFrameInfoType_FramingFrameInfo,
...
enum CrDownloadSettingFileType : CrInt32u
{
	...
	CrDownloadSettingFileType_SceneFile = 0x00000003,
...
enum CrDisplayStringType : CrInt32u
{
	...
	CrDisplayStringType_ExposureIndex_Preset1_Display = 0x0000000F,
	...
	CrDisplayStringType_BaseLook_MetaRecordSupport_Display = 0x00000016,
	CrDisplayStringType_Target_StreamingDestinationSelect_Display = 0x00000017,
	...
	CrDisplayStringType_CustomGridLine_FileName_Display = 0x0000001B,
};
...
enum CrCreativeLook : CrInt16u
{
	...
	CrCreativeLook_Film2,
	CrCreativeLook_Film3,
...
// Bulb Timer Setting
// This property is valid when CrDeviceProperty_ShutterSpeed is CrShutterSpeed_Bulb.
...
enum CrPresetPTZFSettingType : CrInt8u
{
	CrPresetPTZFSettingType_current = 0x01,
};

enum CrPresetPTZFThumbnail : CrInt8u
{
...
// Pan Position Status
enum CrPanPositionStatus : CrInt16u
{
...
enum CrTiltPositionStatus : CrInt16u
{
...
enum CrPanTiltAccelerationRampCurve : CrInt8u
{
	CrPanTiltAccelerationRampCurve_Invalid = 0x00,
};

// Pan Limit Mode
enum CrPanLimitMode : CrInt8u
{
...
// Camera Power Status
enum CrCameraPowerStatus : CrInt8u
{
...
// IR Remote Setting
enum CrIRRemoteSetting : CrInt8u
{
...
enum CrIPSetupProtocolSetting : CrInt8u
{
...
enum CrRecordablePowerSources : CrInt8u
{
...
enum CrDeleteContentOperationEnableStatus : CrInt8u
{
...
// Iris Close Setting
enum CrIrisCloseSetting : CrInt8u
{
	CrIrisCloseSetting_Off	= 0x01,
	CrIrisCloseSetting_On,
};

// Displayed Menu Status
enum CrDisplayedMenuStatus : CrInt8u
{
	CrDisplayedMenuStatus_Off			= 0x01,
	CrDisplayedMenuStatus_StatusMenu,
	CrDisplayedMenuStatus_FullMenu,
};

// Language Setting
enum CrLanguageSetting : CrInt8u
{
	CrLanguageSetting_Invalid		= 0x00,
	CrLanguageSetting_English,
	CrLanguageSetting_Japanese,
	CrLanguageSetting_SimplifiedChinese,
	CrLanguageSetting_TraditionalChinese,
	CrLanguageSetting_Korean,
	CrLanguageSetting_Spanish,
	CrLanguageSetting_Russian,
	CrLanguageSetting_BrazilianPortuguese,
	CrLanguageSetting_Portuguese,
	CrLanguageSetting_Indonesian,
	CrLanguageSetting_French,
	CrLanguageSetting_German,
	CrLanguageSetting_Italian,
	CrLanguageSetting_Dutch,
	CrLanguageSetting_Greek,
	CrLanguageSetting_Arabic,
	CrLanguageSetting_Persian,
	CrLanguageSetting_Thai,
	CrLanguageSetting_Turkish,
	CrLanguageSetting_Polish,
	CrLanguageSetting_Czech,
	CrLanguageSetting_Hungarian,
	CrLanguageSetting_Malay,
	CrLanguageSetting_Hindi,
};

// Playback Contents Recording Frame Rate
enum CrPlaybackContentsRecordingFrameRate : CrInt8u
{
	CrPlaybackContentsRecordingFrameRate_120p			= 0x01,
	CrPlaybackContentsRecordingFrameRate_100p,
	CrPlaybackContentsRecordingFrameRate_60p,
	CrPlaybackContentsRecordingFrameRate_50p,
	CrPlaybackContentsRecordingFrameRate_30p,
	CrPlaybackContentsRecordingFrameRate_25p,
	CrPlaybackContentsRecordingFrameRate_24p,
	CrPlaybackContentsRecordingFrameRate_23_98p,
	CrPlaybackContentsRecordingFrameRate_29_97p,
	CrPlaybackContentsRecordingFrameRate_59_94p,
	CrPlaybackContentsRecordingFrameRate_19_98p,
	CrPlaybackContentsRecordingFrameRate_14_99p,
	CrPlaybackContentsRecordingFrameRate_12_50p,
	CrPlaybackContentsRecordingFrameRate_12_00p,
	CrPlaybackContentsRecordingFrameRate_11_99p,
	CrPlaybackContentsRecordingFrameRate_10_00p,
	CrPlaybackContentsRecordingFrameRate_9_99p,
	CrPlaybackContentsRecordingFrameRate_6_00p,
	CrPlaybackContentsRecordingFrameRate_5_99p,
	CrPlaybackContentsRecordingFrameRate_5_00p,
	CrPlaybackContentsRecordingFrameRate_4_995p,
	CrPlaybackContentsRecordingFrameRate_24_00p,
	CrPlaybackContentsRecordingFrameRate_119_88p,
	CrPlaybackContentsRecordingFrameRate_120i			= 0x41,
	CrPlaybackContentsRecordingFrameRate_100i,
	CrPlaybackContentsRecordingFrameRate_60i,
	CrPlaybackContentsRecordingFrameRate_50i,
	CrPlaybackContentsRecordingFrameRate_30i,
	CrPlaybackContentsRecordingFrameRate_25i,
	CrPlaybackContentsRecordingFrameRate_24i,
	CrPlaybackContentsRecordingFrameRate_23_98i,
	CrPlaybackContentsRecordingFrameRate_29_97i,
	CrPlaybackContentsRecordingFrameRate_59_94i,
	CrPlaybackContentsRecordingFrameRate_19_98i,
	CrPlaybackContentsRecordingFrameRate_14_99i,
	CrPlaybackContentsRecordingFrameRate_12_50i,
	CrPlaybackContentsRecordingFrameRate_12_00i,
	CrPlaybackContentsRecordingFrameRate_11_99i,
	CrPlaybackContentsRecordingFrameRate_10_00i,
	CrPlaybackContentsRecordingFrameRate_9_99i,
	CrPlaybackContentsRecordingFrameRate_6_00i,
	CrPlaybackContentsRecordingFrameRate_5_99i,
	CrPlaybackContentsRecordingFrameRate_5_00i,
	CrPlaybackContentsRecordingFrameRate_4_995i,
	CrPlaybackContentsRecordingFrameRate_24_00i,
	CrPlaybackContentsRecordingFrameRate_119_88i,
};

// Playback Contents Recording File Format
enum CrPlaybackContentsRecordingFileFormat : CrInt8u
{
...
enum CrPlaybackContentsGammaType : CrInt16u
{
	CrPlaybackContentsGammaType_S_Gamut3_S_Log3	= 0x0001,
	CrPlaybackContentsGammaType_S_Gamut3_Cine_S_Log3,
	CrPlaybackContentsGammaType_BT2020_HLG,
	CrPlaybackContentsGammaType_BT2020_S_Log3,
	CrPlaybackContentsGammaType_Others			= 0xFFFF,
};

// BaseLook Applied of Playback
enum CrBaseLookAppliedofPlayback : CrInt8u
{
	CrBaseLookAppliedofPlayback_Applicable	= 0x01,
	CrBaseLookAppliedofPlayback_Not_Applicable,
};

// Paint/Look User Matrix Setting
// Paint/Look Multi Matrix Setting
enum CrPaintLookMatrixSetting : CrInt8u
{
	CrPaintLookMatrixSetting_Off	= 0x01,
	CrPaintLookMatrixSetting_On,
};

// Paint/Look Multi Matrix Axis
enum CrPaintLookMultiMatrixAxis : CrInt16u
{
...
enum CrPaintLookMultiMatrixAreaIndication : CrInt8u
{
...
// Focus Mode status
enum CrFocusModeStatus : CrInt8u
{
	CrFocusModeStatus_FocusHold	= 0x01,
	CrFocusModeStatus_MF_Operation,
	CrFocusModeStatus_AF_Operation,
};

// Focus Operation with INT16 Enable Status
enum CrFocusOperationWithInt16EnableStatus : CrInt8u
{
	CrFocusOperationWithInt16EnableStatus_Disable	= 0x00,
	CrFocusOperationWithInt16EnableStatus_Enable,
};
...
enum CrAudioInputCHLevelControl : CrInt8u
{
	CrAudioInputCHLevelControl_Auto	= 0x01,
	CrAudioInputCHLevelControl_Manual,
};
...
enum CrAudioInputCHInputSelect : CrInt8u
{
	CrAudioInputCHInputSelect_Off	= 0x01,
	CrAudioInputCHInputSelect_INPUT1,
	CrAudioInputCHInputSelect_INPUT2,
	CrAudioInputCHInputSelect_InternalMIC,
	CrAudioInputCHInputSelect_ShoeCH1,
	CrAudioInputCHInputSelect_ShoeCH2,
	CrAudioInputCHInputSelect_StereoMicJackL,
	CrAudioInputCHInputSelect_StereoMicJackR,
};
...
enum CrAudioInputCHWindFilter : CrInt8u
{
	CrAudioInputCHWindFilter_Off	= 0x01,
	CrAudioInputCHWindFilter_On,
};

// Audio Input1 Type Select
// Audio Input2 Type Select
enum CrAudioInputTypeSelect : CrInt8u
{
	CrAudioInputTypeSelect_MIC = 0x01,
	CrAudioInputTypeSelect_LINE,
};

// Remote Key Thumbnail Button
enum CrRemoteKeyThumbnailButton : CrInt16u
{
	CrRemoteKeyThumbnailButton_Up			= 0x0001,
	CrRemoteKeyThumbnailButton_Down,
};

// Remote Key SLOT Select Button
enum CrRemoteKeySLOTSelectButton : CrInt16u
{
	CrRemoteKeySLOTSelectButton_Up			= 0x0001,
	CrRemoteKeySLOTSelectButton_Down,
};

// Video Recording Format Bitrate Setting
enum CrVideoRecordingFormatBitrateSetting : CrInt16u
{
	CrVideoRecordingFormatBitrateSetting_None	= 0x0000,
};

// Valid Recording Video Format[bit0-7] : Resolution
enum CrValidRecordingVideoFormat_Resolution : CrInt32u
{
...
// Valid Recording Video Format[bit8-15] : Bitrate
enum CrValidRecordingVideoFormat_Bitrate : CrInt32u
{
...
// Valid Recording Video Format[bit16] : Scan Line Type
// 0b0	Progressive
// 0b1	Interlace
enum CrValidRecordingVideoFormat_ScanLineType : CrInt32u
{
...
// Valid Recording Video Format[bit17-31] : Reserved

// Video Recording Format Quality
enum CrVideoRecordingFormatQuality : CrInt16u
{
	CrVideoRecordingFormatQuality_Level1			= 0x0001,
	CrVideoRecordingFormatQuality_Level2,
	CrVideoRecordingFormatQuality_Level3,
};

// Red Tally Lamp Control
// Green Tally Lamp Control
// Yellow Tally Lamp Control
enum CrTallyLampControl : CrInt8u
{
	CrTallyLampControl_Off	= 0x01,
	CrTallyLampControl_On,
};

// Picture Cache Rec Setting
enum CrPictureCacheRecSetting : CrInt8u
{
	CrPictureCacheRecSetting_Off	= 0x01,
	CrPictureCacheRecSetting_On,
};

// Imager Scan Mode
enum CrImagerScanMode : CrInt8u
{
	CrImagerScanMode_Auto		= 0x01,
	CrImagerScanMode_FullFrame,
	CrImagerScanMode_S35,
};

// Picture Cache Rec Size and Time
// The cache size [Upper 8bits], cache rec time(1/100sec) [Lower 24bits]
// e.g.) 0x010001F4 = Short 5sec
//       0x020003E8 = Middle 10sec
//       0x030007D0 = Long 20sec
//       0x04000C1C = Max 31sec
enum CrPictureCacheRecSizeAndTime_CacheSizeMask : CrInt32u
{
...
enum CrShootingEnableSettingLicense : CrInt8u
{
	CrShootingEnableSettingLicense_Enable	= 0x01,
	CrShootingEnableSettingLicense_Disable,
};

// Grid Line Type
enum CrGridLineType : CrInt8u
{
...
enum CrStreamButtonEnableStatus : CrInt8u
{
	CrStreamButtonEnableStatus_Disable	= 0x00,
	CrStreamButtonEnableStatus_Enable,
};

// StreamSettingList Operation Enable Status
enum CrStreamSettingListOperationStatus : CrInt8u
{
	CrStreamSettingListOperationStatus_Disable = 0x00,
	CrStreamSettingListOperationStatus_Enable = 0x01,
};

// Different Set for S&Q/Movie
enum CrDifferentSetForSQMovie : CrInt8u
{
	CrDifferentSetForSQMovie_On_Different = 0x01, //Different
	CrDifferentSetForSQMovie_Off_Identical,       //Identical
};
// Log Shooting Mode <Still>
enum CrLogShootingMode : CrInt16u
{
...
enum CrLogShootingModeColorGamut : CrInt8u
{
    CrLogShootingModeColorGamut_S_Gamut3_Cine  = 0x01,
    CrLogShootingModeColorGamut_S_Gamut3,
};

// Video Stream Adaptive Rate Control
enum CrVideoStreamAdaptiveRateControl : CrInt8u
{
	CrVideoStreamAdaptiveRateControl_Off  = 0x01,
	CrVideoStreamAdaptiveRateControl_On,
};

// Video Stream Codec
enum CrVideoStreamCodec : CrInt16u
{
	CrVideoStreamCodec_Off        = 0x0001,
	CrVideoStreamCodec_MotionJpeg,
	CrVideoStreamCodec_H264,
	CrVideoStreamCodec_H265,
};

// Stream Cipher Type
enum CrStreamCipherType : CrInt8u
{
	CrStreamCipherType_None     = 0x01,
	CrStreamCipherType_AES_128,
	CrStreamCipherType_AES_192,
	CrStreamCipherType_AES_256,
};

// Stream Mode Setting
enum CrStreamModeSetting : CrInt8u
{
	CrStreamModeSetting_Undefined   = 0x01,
	CrStreamModeSetting_Caller,
	CrStreamModeSetting_Listener,
	CrStreamModeSetting_Rendezvous,
};

// Video Stream Resolution Method
enum CrVideoStreamResolutionMethod : CrInt8u
{
	CrVideoStreamResolutionMethod_Manualmode = 0x01,
	CrVideoStreamResolutionMethod_Easymode,
};

// Video Stream Movie Rec Permission
enum CrVideoStreamMovieRecPermission : CrInt8u
{
	CrVideoStreamMovieRecPermission_NotPermitted = 0x01,
	CrVideoStreamMovieRecPermission_Permitted,
};

// Video Stream Bit Rate Compression Mode
enum CrVideoStreamBitRateCompressionMode : CrInt8u
{
	CrVideoStreamBitRateCompressionMode_ConstantBitRate_CBR = 0x01,
	CrVideoStreamBitRateCompressionMode_VariableBitRate_VBR,
};

// Video Stream Bit Rate VBR Mode
enum CrVideoStreamBitRateVBRMode : CrInt8u
{
	CrVideoStreamBitRateVBRMode_Standard     = 0x01,
	CrVideoStreamBitRateVBRMode_BitRateLimit,
};

// Audio Stream Codec Type
enum CrAudioStreamCodecType : CrInt8u
{
	CrAudioStreamCodecType_AACLC = 0x20,
};

// Audio Stream Bit Depth
enum CrAudioStreamBitDepth : CrInt8u
{
	CrAudioStreamBitDepth_16bit = 0x01,
	CrAudioStreamBitDepth_24bit,
	CrAudioStreamBitDepth_32bit,
};

// Audio Stream Channel
enum CrAudioStreamChannel : CrInt8u
{
...
enum CrHomeMenuSetting : CrInt8u
{
	CrHomeMenuSetting_NDFilter = 0x01,
	CrHomeMenuSetting_Aperture,
};

// Live View Protocol
enum CrLiveViewProtocol : CrInt32u
{
	CrLiveViewProtocol_None = 0,
	CrLiveViewProtocol_Main,
	CrLiveViewProtocol_Alt,
};

// Call Setting
enum CrCallSetting : CrInt8u
{
...
// SceneFile Index
enum CrSceneFileIndex : CrInt32u
{
...
// SceneFile Upload/Download Enable Status
enum CrSceneFileOperationEnableStatus : CrInt8u
{
	CrSceneFileOperationEnableStatus_Disable = 0x00,
	CrSceneFileOperationEnableStatus_Enable,
};

// Monitoring Output Format
enum CrMonitoringOutputFormat : CrInt8u
{
	CrMonitoringOutputFormat_None              = 0x00,
	CrMonitoringOutputFormat_59_94_720x480P    = 0x01,
	CrMonitoringOutputFormat_50_00_720x576P    = 0x01,
...
enum CrMonitoringOutputDisplaySetting : CrInt8u
{
	CrMonitoringOutputDisplaySetting_Off = 0x01,
	CrMonitoringOutputDisplaySetting_On,
};

// Eframing Type
enum CrEframingType : CrInt8u
{
	CrEframingType_None = 0x01,
	CrEframingType_Auto,
	CrEframingType_Single,
	CrEframingType_PTZ = 0x05,
	CrEframingType_HoldCurrentPosition = 0x08,
	CrEframingType_ForceZoomOut,
};

// Eframing Auto Framing
enum CrEframingAutoFraming : CrInt8u
{
	CrEframingAutoFraming_Off = 0x01,
	CrEframingAutoFraming_On,
};

// Eframing Tracking Start Mode
enum CrEframingTrackingStartMode : CrInt8u
{
	CrEframingTrackingStartMode_Auto = 0x01,
	CrEframingTrackingStartMode_Manual,
};

// Eframing Production Effect
enum CrEframingProductionEffect : CrInt16u
{
	CrEframingProductionEffect_Off = 0x0001,
	CrEframingProductionEffect_IntervalZoomInOut_15sec,
	CrEframingProductionEffect_IntervalZoomInOut_30sec,
};

// High Resolution Shutter Speed Adjust
// CrDataType_Int16Range
// This property can be changed only when CrDeviceProperty_HighResolutionShutterSpeed is Enable.

// High Resolution Shutter Speed Adjust In Integral Multiples
// CrDataType_Int16Range
// This property can be changed only when CrDeviceProperty_HighResolutionShutterSpeed is Enable.

// Top Of The Group Shooting Mark Setting
enum CrTopOfTheGroupShootingMarkSetting : CrInt16u
{
...
extern "C"
SCRSDK_API
CrError Set2byte_CharBuffer(CrInt8u** dp, const char* src);

inline const char* Get2byte_CharBuffer(CrInt8u* dp)
{
	if (dp == nullptr)
		return nullptr;
...
public:
	...
	bool IsGetEnableCurrentValue()const;

	bool IsSetEnableCurrentValue()const;

	void SetCode(CrInt32u code);

	CrInt32u GetCode()const;
	...
	CrPropertyEnableFlag GetPropertyEnableFlag()const;

	// Do not use. Will be removed in the next release.
	void SetPropertyVariableFlag(CrPropertyVariableFlag flag);

	CrPropertyVariableFlag GetPropertyVariableFlag()const;

	void SetCurrentValue(CrInt64u value);
	CrInt64u GetCurrentValue()const;

	void SetCurrentStr(CrInt16u* str);
	CrInt16u* GetCurrentStr()const;
	...
	CrInt32u GetSetValueSize()const;

	// Do not use. Will be removed in the next release.
	void SetSetValues(CrInt8u* value);

	CrInt8u* GetSetValues()const;

	CrInt32u GetDisplayValueSize()const;

	CrInt8u* GetDisplayValues()const;
...
public:
	...
	CrFrameInfoType GetFrameInfoType()const;
...
#pragma pack(1)
class CrFramingFrameInfo
{
public:
	CrFramingFrameInfo()
		: type(CrFramingFrameType_Unknown)
		, priority(0)
		, xNumerator(0)
		, xDenominator(0)
		, yNumerator(0)
...
public:
	...
	CrFTPServerSetting(
		...
		CrFTPServerRootCertificateErrorSetting rootCertificateErrorSetting);
	~CrFTPServerSetting();
	CrFTPServerSetting(const CrFTPServerSetting& ref);
	CrFTPServerSetting& operator = (const CrFTPServerSetting& ref);

	const char* GetDisplayName() { return Get2byte_CharBuffer(displayName); }
	const char* GetHostName() { return Get2byte_CharBuffer(hostName); }
	const char* GetUserName_() { return Get2byte_CharBuffer(userName); }
	const char* GetPassword() { return Get2byte_CharBuffer(password); }
	const char* GetDestinationDir() { return Get2byte_CharBuffer(destinationDir); }
...
public:
	...
	const char* GetClipName() { return Get2byte_CharBuffer(clipName); }
	const char* GetMainName() { return Get2byte_CharBuffer(mainName); }
	const char* GetMetaName() { return Get2byte_CharBuffer(metaName); }
...
public:
	...
	const char* GetClipPath() { return Get2byte_CharBuffer(clipPath); }
	const char* GetMetaPath() { return Get2byte_CharBuffer(metaPath); }
	const char* GetTransferDir() { return Get2byte_CharBuffer(transferDir); }
	const char* GetDestClipName() { return Get2byte_CharBuffer(destClipName); }
	const char* GetVideoType() { return Get2byte_CharBuffer(videoType); }
...
public:
	CrError SetIpAddress(const char* _ipAddress) { return Set2byte_CharBuffer(&ipAddress, _ipAddress); }
	const char* GetIpAddress() { return Get2byte_CharBuffer(ipAddress); }
...
enum CrPTZFControlType : CrInt32u
{
	CrPTZFControlType_Absolute		= 0x00000001,
	CrPTZFControlType_Relative		= 0x00000002,
	CrPTZFControlType_Direction		= 0x00000003,
	CrPTZFControlType_HomePosition	= 0x00000004,
	CrPTZFControlType_Reset			= 0x00000005,
	CrPTZFControlType_Cancel		= 0x00000006,
	CrPTZFControlType_Max,
};

struct SCRSDK_API CrDrivePanSetting {
	CrDrivePanSetting()
		:
		exists(0)
		, speed(0)
...
struct SCRSDK_API CrDriveTiltSetting {
	CrDriveTiltSetting()
		:
		exists(0)
		, speed(0)
...
class SCRSDK_API CrPTZFSetting
{
public:
	CrPTZFSetting()
		:
	...
	CrDrivePanSetting pan;
	CrDriveTiltSetting tilt;
private:
};

enum CrTimeZoneSettingExists : CrInt8u
{
	CrTimeZoneSettingExists_False = 0x00,
	CrTimeZoneSettingExists_True	= 0x01,
};

enum CrDaylightSavings : CrInt8u
{
	CrDaylightSavings_Off = 0x00,
	CrDaylightSavings_On = 0x01,
};

class SCRSDK_API CrTimeZoneSetting
{
public:
	struct SCRSDK_API CrDateTimeSetting
	{
		CrDateTimeSetting()
			:exists(CrTimeZoneSettingExists_False),
			dateTime{}
		{}
		CrTimeZoneSettingExists exists;
		char dateTime[18];
	};

	struct SCRSDK_API CrAreaSetting
	{
		CrAreaSetting()
			:exists(CrTimeZoneSettingExists_False),
			area{}
	...
	struct SCRSDK_API CrDaylightSetting
	{
		CrDaylightSetting()
			:exists(CrTimeZoneSettingExists_False),
			daylight(CrDaylightSavings_Off)
		{}
		CrTimeZoneSettingExists exists;
		CrDaylightSavings daylight;
	};
...
public:
	...
	CrDateTimeSetting dateTimeSetting;
	CrAreaSetting areaSetting;
	CrDaylightSetting daylightSetting;
};

#define CrEFRAMING_AREAINFO_MAX 4

enum CrEframingAreaNumber : CrInt16u
{
	CrEframingArea1 = 1,
	CrEframingArea2 = 2,
	CrEframingArea3 = 3,
...
enum CrEframingAreaGroup : CrInt32u
{
	CrEframingInputArea = 1,
	CrEframingOutputArea = 2,
};
...
typedef std::unordered_map<CrInt32u, CrEframingRectangle> CrEframingRectangleList;

class SCRSDK_API CrEframingInfo
{
public:
	CrEframingInfo();
	~CrEframingInfo();
	CrEframingInfo(const CrEframingInfo& ref);
	CrEframingInfo& operator =(const CrEframingInfo& ref);
	bool addInputInfo(const CrInt32u areaNum, CrEframingRectangle inputInfo);
	bool addOutputInfo(const CrInt32u areaNum, CrEframingRectangle outputInfo);
	bool removeInputInfo(const CrInt32u areaNum);
	bool removeOutputInfo(const CrInt32u areaNum);
	CrEframingRectangleList getInputInfos();
	CrEframingRectangleList getOutputInfos();

public:
	CrInt32 horizontal_denominator;
	CrInt32 vertical_denominator;
	CrEframingType eframingType;

private:
#pragma warning(push)
#pragma warning(disable:4251)
	CrEframingRectangleList inputList;
	CrEframingRectangleList outputList;
#pragma warning(pop)
};

#pragma pack(1)
enum CrVideoStreamSettingProtocol : CrInt8u
{
	CrVideoStreamSettingProtocol_None = 0x00,
	CrVideoStreamSettingProtocol_RTMP = 0x01 << 0,
	CrVideoStreamSettingProtocol_SRT  = 0x01 << 1,
};

class SCRSDK_API CrVideoStreamSetting
{
public:
    CrVideoStreamSetting();
    CrVideoStreamSetting(const CrVideoStreamSetting& ref);

    ~CrVideoStreamSetting();

    CrVideoStreamSetting& operator = (const CrVideoStreamSetting& ref);

    void SetRTMPParameter(CrInt16u urlLength, const CrInt8u* url, CrInt16u keyLength, const CrInt8u* key);
    void SetSRTParameter(CrInt16u urlLength, const CrInt8u* url, CrInt32u port, CrInt16u latency, CrInt8u ttl, CrStreamCipherType cipherType, CrInt8u cipherKeyLength, const CrInt8u* cipherKey, CrStreamModeSetting mode);

    CrVideoStreamSettingProtocol GetProtocol() const;
    CrInt8u GetProtocolPermission() const;
    CrInt16u GetURLLength() const;
    const CrInt8u* GetURL() const;
    bool IsPortExists() const;
    CrInt32u GetPort() const;
    CrInt16u GetKeyLength() const;
    bool IsKeyExists() const;
    const CrInt8u* GetKey() const;
    bool IsLatencyExists() const;
    CrInt16u GetLatency() const;
    bool IsTTLExists() const;
    CrInt8u GetTTL() const;
    bool IsCipherExists() const;
    CrStreamCipherType GetCipherType() const;
    CrInt8u GetCipherKeyLength() const;
    const CrInt8u* GetCipherKey() const;
    bool IsModeExists() const;
    CrStreamModeSetting GetMode() const;

private:
    CrVideoStreamSettingProtocol protocol;
    CrInt8u protocolPermission;
    CrInt16u urlLength;
    CrInt8u* url;
    bool portExists;
    CrInt32u port;
    ...
    CrInt8u ttl;
    bool cipherExists;
    CrStreamCipherType cipherType;
    CrInt8u cipherKeyLength;
    CrInt8u* cipherKey;
    bool modeExists;
    CrStreamModeSetting mode;
};
#pragma pack()
